...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.vocabwin6.vocabwin6.MainActivity";
    ...
    public void onClickDownload(View view) {
        ...
        String url = "https://vocabwin.herokuapp.com/units6/" + id;
    ...
    public void fromToPages(View view) {
        ...
        if(fromTextInt < 168 || toTextInt > 199 || fromTextInt > toTextInt) {
            ...
            String url = "https://vocabwin.herokuapp.com/pages6?from=" + fromText + "&to=" + toText;
