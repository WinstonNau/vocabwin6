...
public class GameActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE_2 = "com.vocabwin6.vocabwin6." + TAG + ".max";
    ...
    private void setNewText() {
        try {
            ...
            String url = "https://vocabwin.herokuapp.com/falseChoices6?word=" + answerWithoutSpacesAndSharpS + "&lang=" + language + "&speech=" + speech;
